...
int main() {
  ...
  for (int i = 0; i < (int)keys.size(); i++) {
    ...
    insertCheck = rmq.insert(keys[i], i);
  }
  ...
  cout << "\nRMQ query:\n";
  cout << "  query(97,97) = " << rmq.query(97, 97) << endl;
  ...
  removeCheck = rmq.remove(92);
  cout << "92 removed" << endl;
  rmq.remove(97);
  cout << "97 removed" << endl;
  rmq.remove(-24);
  cout << "-24 removed" << endl;
  rmq.update(77,100);
  cout << "77 updated" << endl;
  ...
  cout << "\nRMQ query:\n";
  cout << "  query(77, 77) = " << rmq.query(77,77) << endl;
  ...
  */
  ...
  for (int i = 0; i < 483; i++) {
	...
	cout << "Fail! (" << i << ", " << j << "); rmq ="
        ...
        cout << "nice (" << i << ", " << j << "); rmq =" << rmqq << ", minq = " << minq << endl;
      }
    }
  }
  cout << "done!\n";
